package hfpocketwhiz.com.helpers
 ...
 */
     ...
     * @return
     */
    fun isInputEditTextFilled(textInputEditText: EditText, textInputLayout: EditText, message: String): Boolean {
     ...
     * @return
     */
    fun isInputEditTextEmail(textInputEditText: EditText, textInputLayout: EditText, message: String): Boolean {
        val value = textInputEditText.text.toString().trim()
